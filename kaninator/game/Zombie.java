...
public class Zombie
{
	 ...
	 */
	public Zombie(ArrayList<Animation> animations, Map _map, SoundClip _squirt, DynamicObject _player, double x, double y, double radius_constant) throws ModelException
	{
		map = _map;
