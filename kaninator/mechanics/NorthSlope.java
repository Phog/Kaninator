...
/**
 * A subclass of StaticObject representing a Northward slope.
 * @author phedman
...
{
	/**
	 * Constructs a NorthSlope and sets the tile position of the object and the Drawables it is associated with by passing the parameters to the parent constructor.
	...
	{
		return height - MapFactory.getTileHeight() +  y / 2.0;
	}
