...
/**
 * A subclass of StaticObject representing a South-Westward slope.
 * @author phedman
...
{
	/**
	 * Constructs a SWestSlope and sets the tile position of the object and the Drawables it is associated with by passing the parameters to the parent constructor.
	...
	public double getHeight(double x, double y)
	{
		...
		return height -MapFactory.getTileHeight() + tempHeight/2;
	}
