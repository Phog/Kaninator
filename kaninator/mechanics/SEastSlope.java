...
/**
 * A subclass of StaticObject representing a South-Eastward slope.
 * @author phedman
...
{
	/**
	 * Constructs a SEastSlope and sets the tile position of the object and the Drawables it is associated with by passing the parameters to the parent constructor.
