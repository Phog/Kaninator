...
/**
 * A subclass of StaticObject representing a flat tile.
 * @author phedman
...
{
	/**
	 * Constructs a FlatTile and sets the tile position of the object and the Drawables it is associated with by passing the parameters to the parent constructor.
	...
	/**
	 * Returns the height position of the tile.
